...
يرجى تأكيد فهمك والتزامك باستخدام الزر المخصص لمجالك الوظيفي فقط، وتجنب إصدار تعاميم خارج نطاق صلاحياتك. أي مخالفة سيتم محاسبتها وفقًا لقوانين الوزارة__**`)
 const Buttons = [
 new ButtonBuilder({customId: 'Circulars-1', label: 'تعاميم الأمن', style: 2}),
 new ButtonBuilder({customId: 'Circulars-2', label: 'تعاميم القوات', style: 2}),
 new ButtonBuilder({customId: 'Circulars-3', label: 'تعاميم الداخلية', style: 2}),
 ]
