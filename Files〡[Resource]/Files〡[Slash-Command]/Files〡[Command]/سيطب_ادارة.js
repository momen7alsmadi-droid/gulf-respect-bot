...
export default {
    name: "سيطب_ادارة",
    description: "إنشاء لوحة الإدارة",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Admin]/CD〡[Setup-Adara].js");

        let fakeContent = "Client.Prefix" + "سيطب-ادارة";
            const fakeMsg = {
                content: fakeContent,
