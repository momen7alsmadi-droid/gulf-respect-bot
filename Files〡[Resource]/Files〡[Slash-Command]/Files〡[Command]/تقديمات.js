...
export default {
    name: "تقديمات",
    description: "إنشاء لوحة التقديمات",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Admin]/CD〡[Setup-Submissions].js");

        let fakeContent = "Client.Prefix" + "تقديمات";
            const fakeMsg = {
                content: fakeContent,
