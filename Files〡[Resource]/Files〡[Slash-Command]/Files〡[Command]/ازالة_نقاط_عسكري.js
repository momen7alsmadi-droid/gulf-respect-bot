...
export default {
    name: "ازالة_نقاط_عسكري",
    description: "إزالة نقاط من عسكري",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Police]/CD〡[Remove Points].js");

        let fakeContent = "Client.Prefix" + "إزالة-نقاط-عسكري";
