...
export default {
    ...
    */
    run: async (Client, Message) => {
        if (!Message.member.roles.cache.has(CommandPremission.SetupTicket)) return Message.reply({ content: `**ليس لديك الصلاحية لتنفيذ هذا الامر**` });
...
<a:GulfRecPecT:1415964745017724990> – مـرحـبـا بـك عـزيـزي الـعـضـو فـي تكت الـتـفـعـيـل

<a:GulfRecPecT:1416329668579164290> – لـلـتـفـعـيـل فـي قولف ريسبكت  الـرجـاء الـنـقـر عـلـى ( تكت تـفـعـيـل )
<a:GulfRecPecT:1415963988541313117> — ويـرجـى الالـتـزام بالانـظـمـة الـمـوضـحـة ادنـاه:
...
<a:GulfRecPecT:1415964745017724990> – مـرحـبـآ بـك عـزيـزي الـعـضـو فـي قـسـم طلب اونر .— يـرجـى الألـتـزام باللائحة الـمـوضـحـة .
...
<a:GulfRecPecT:1416351128169353247> – نـرجـوا مـنـك الإلـتـزام بـالـقـوانـيـن وعـدم مـخـالـفـتـهـا__**
\`\`\`               𝗚𝘂𝗹𝗙 𝗥𝗲𝗰𝗣𝗲𝗰𝗧  \`\`\``);
            ...
            case 'المساعدة': {
                Embed.setDescription(`**__
<a:GulfRecPecT:1415964745017724990> – مـرحـبـآ بـك عـزيـزي الـعـضـو فـي قـسـم المساعدة .— يـرجـى الألـتـزام باللائحة الـمـوضـحـة .

1 - أحـتـرام الأدارة.<a:GulfRecPecT:1415963988541313117> 
...
\`\`\`               𝗚𝘂𝗹𝗙 𝗥𝗲𝗰𝗣𝗲𝗰𝗧  \`\`\``);
            ...
            case 'الشكاوى': {
                Embed.setDescription(`**__— مـرحـبـآ بـك عـزيـزي الـعـضـو <a:GulfRecPecT:1415964745017724990> فـي قـسـم الشكاوى العامة .— يـرجـى الألـتـزام باللائحة الـمـوضـحـة .

1 –<a:GulfRecPecT:1415963988541313117> أحـتـرام بين الطرفين.
...
<a:GulfRecPecT:1416352136295350396> — نـرجـوا مـنـك الإلـتـزام بـالـقـوانـيـن وعـدم مـخـالـفـتـهـا__**
\`\`\`               𝗚𝘂𝗹𝗙 𝗥𝗲𝗰𝗣𝗲𝗰𝗧  \`\`\``);
...
<a:GulfRecPecT:1415964745017724990> - مـرحـبـاً بـك عـزيـزي الـعـضـو فـي سـيـرفـر قـولـف ريـسـبـكـت لـلـتـقـديـم عـلـى إدارة قـولـف ريـسـبـكـت قـم بـفـتـح تـكـت 

<a:GulfRecPecT:1415963988541313117> - مـلاحـظـة
...
- مـتـمـنـيـن لـكـم اوقـات مـمـتـعـه فـي قـولـف ريـسـبـكـت __**`);
 ...
 <:GuLFResPecT:1416434657192579216>  — لـرفـع قـضـيـة عـامـة أو جـنـائـيـة تـفـضـل بـرفـع ذلـك لـوزارة الـعـدل مـع كـامـل الـتـفـاصـيـل .

<:GuLFResPecT:1416537815415652352> — لـطـلـب مـحـامـي فـي أي قـضـيـة كـانـت يـمـكـنـك طـلـب ذلـك بـالـزر بالأسـفـل
