...
__**`)
 const Buttons = [
 new ButtonBuilder({ customId: 'CivilRegistry〡Create', label: 'إنشاء سجل', style: 2 }),
 new ButtonBuilder({ customId: 'CivilRegistry〡View', label: 'استعلام', style: 2 }),
 new ButtonBuilder({ customId: 'CivilRegistry〡Edit', label: 'تعديل سجل', style: 2 })
 ]
