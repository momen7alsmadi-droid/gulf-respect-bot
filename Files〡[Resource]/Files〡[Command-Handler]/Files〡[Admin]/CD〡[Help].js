...
const AdminCommands = [
 ...
 { name: '=رسائل', value: '📝 التحكم بجميع رسائل البوت - 96 عنصر (للإدارة العليا)' },
 { name: '=لوحة-تحكم', value: '🛡️ لوحة تحكم البوت - تعديل كل المعرفات (للإدارة العليا)' },
 { name: '=مالك', value: '👑 إدارة الملاك - إضافة/حذف/عرض (للمالك فقط)' },
 
 // ═══════════ أوامر سلاش ═══════════
 { name: '═══ 📁 أوامر سلاش (/) ═══', value: ' ' },
 { name: '/رولات', value: 'إعطاء أو إزالة رولات بالجملة (4 أقسام: إدارة - مناصب - عصابات - عامة)' },
 { name: '/خط', value: 'رفع صورة الخط الفاصل (للأدمن فقط)' },
 { name: '/بطاقة', value: '🎨 إنشاء بطاقة عضوية مخصصة باسم ورتبة العضو' },
 { name: '/شهادة', value: '🎨 إنشاء شهادة تقدير للعضو مع ذكر السبب' },
 { name: '/توب', value: '🎨 عرض توب النقاط (الإدارة أو العساكر) كصورة' },
];
...
const MemberCommands = [
    ...
    { name: '=خط', value: 'إرسال الخط الفاصل' },
];
