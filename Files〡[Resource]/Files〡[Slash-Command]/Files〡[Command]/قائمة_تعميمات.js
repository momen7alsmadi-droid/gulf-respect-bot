...
export default {
    name: "قائمة_تعميمات",
    description: "إنشاء لوحة التعاميم",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Admin]/CD〡[Circulars].js");

        let fakeContent = "Client.Prefix" + "قائمه-تعميمات";
            const fakeMsg = {
                content: fakeContent,
