...
**`)
                const Button = new ButtonBuilder({ customId: 'ID〡Submit-ID', label: 'قرأت الشروط', style: 2, emoji: '' })
            ...
            case 'ID〡My': {
                ...
                const Button = new ButtonBuilder({ customId: 'ID〡My', label: 'عرض هويتي', style: 2, emoji: '' })
            ...
            case 'ID〡Submit-ID': {
                ...
                collector.on('collect', async Message => {
                    ...
                    if (Image) {
                        ...
                        const Buttons = [
                            new ButtonBuilder({ customId: 'ID〡Accept', label: 'قبول', style: 3, emoji: '' }),
                            new ButtonBuilder({ customId: 'ID〡Reject', label: 'رفض', style: 4, emoji: '' })
                        ]
