...
export default {
    name: "سيطب_الهوية",
    description: "إنشاء لوحة الهوية الوطنية",
    type: 1,
    options: [
        { name: "النوع", description: "نوع اللوحة", type: ApplicationCommandOptionType.String, required: true, choices: [{ name: "تقديم هوية", value: "تقديم-هوية" }, { name: "عرض هوية", value: "عرض-هوية" }] }
    ],
    run: async (Client, Message) => {
        await Message.deferReply({ flags: 64 });
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Admin]/CD〡[Setup-ID].js");

        let fakeContent = "Client.Prefix" + "سيطب-الهوية";
