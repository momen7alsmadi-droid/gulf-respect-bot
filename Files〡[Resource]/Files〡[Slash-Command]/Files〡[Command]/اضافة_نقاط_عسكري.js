...
export default {
    name: "اضافة_نقاط_عسكري",
    description: "إضافة نقاط لعسكري",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Police]/CD〡[Add Points].js");

        let fakeContent = "Client.Prefix" + "إضافة-نقاط-عسكري";
