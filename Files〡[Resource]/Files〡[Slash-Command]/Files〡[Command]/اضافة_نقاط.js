...
export default {
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Admin]/CD〡[Add-Point].js");

        let fakeContent = "Client.Prefix" + "اضافة-نقاط";
