...
export default {
    name: "بانل_المخالفات",
    description: "إنشاء لوحة المخالفات",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Police]/CD〡[Panel Violations].js");

        let fakeContent = "Client.Prefix" + "بانل-المخالفات";
            const fakeMsg = {
                content: fakeContent,
