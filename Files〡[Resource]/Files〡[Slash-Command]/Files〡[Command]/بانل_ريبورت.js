...
export default {
    name: "بانل_ريبورت",
    description: "إنشاء لوحة البلاغات",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Police]/CD〡[Panel-Report].js");

        let fakeContent = "Client.Prefix" + "بانل-ريبورت";
            const fakeMsg = {
                content: fakeContent,
