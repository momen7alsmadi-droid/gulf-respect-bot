...
__**`);
 const AlShuriVote = new ButtonBuilder({ customId: 'Al-Shuri-Vote', label: 'بــدء تــصــويــت', style: 2 });
 const AlShuriEnd = new ButtonBuilder({ customId: 'Al-Shuri-End', label: 'إنــهــاء تــصــويــت', style: 2 });
