...
export default {
    name: "تصفير_نقاط",
    description: "تصفير جميع نقاط إداري",
    type: 1,
    options: [
    ...
    run: async (Client, Message) => {
        ...
        try {
            const { default: origCmd } = await import("../../Files〡[Command-Handler]/Files〡[Admin]/CD〡[Delete-Point].js");

        let fakeContent = "Client.Prefix" + "تصفير-نقاط";
