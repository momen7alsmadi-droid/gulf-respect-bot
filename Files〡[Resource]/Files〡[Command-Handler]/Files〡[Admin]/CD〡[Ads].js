...
export default {
    ...
    */
    run: async (Client, Message) => {
        if (!Message.member.roles.cache.has(CommandPremission.Ads)) return Message.reply({ content: `**ليس لديك الصلاحية لتنفيذ هذا الامر**` });
...
بتوفيق وزارة الاعلام ترحب بكم**`)
        ...
        SelectMenu.addOptions([
            { label: 'عصابة', value: 'Ads-1', emoji: '<:GulfRecPecT:1416351119680208977>' },
            { label: 'وزارة الداخلية', value: 'Ads-2', emoji: '<:GulFRecPecT:1416537809958998118>' },
            { label: 'رئيس الجمهورية', value: 'Ads-3', emoji: '<:GuLFResPecT:1416435232369934338>' },
            { label: 'مجلس البرلمان', value: 'Ads-4', emoji: '<:GuLFResPecT:1416435232369934338>' },
            { label: 'مسؤول العصابات', value: 'Ads-5', emoji: '<:GulfRecPecT:1416351119680208977>' },
            { label: 'رجل مجهول', value: 'Ads-6', emoji: '<:GulfRecPecT:1415965105266622555>' },
            { label: 'وزارة الاعلام', value: 'Ads-7', emoji: '<:GuLFResPecT:1416537812265865256>' },
            { label: 'هيئة مكافحة الفساد', value: 'Ads-8', emoji: '<:GuLFResPecT:1416435232369934338>' }
        ]);
