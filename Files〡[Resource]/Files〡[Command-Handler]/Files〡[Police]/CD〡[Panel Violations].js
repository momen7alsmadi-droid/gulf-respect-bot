...
export default {
    ...
    */
    run: async (Client, Message) => {
        if (!Message.member.roles.cache.has(Police.PanelM5alfat)) return Message.reply({ content: `**ليس لديك الصلاحية لتنفيذ هذا الامر**` });
...
__**`)
        const Button = new ButtonBuilder({ customId: 'Violations〡Member', label: 'اعطاء مخالفة', style: 2, emoji: '<a:GulfRecPecT:1416352136295350396>' })
