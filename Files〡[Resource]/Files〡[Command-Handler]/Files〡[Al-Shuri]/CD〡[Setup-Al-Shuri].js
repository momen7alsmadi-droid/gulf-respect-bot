...
ــشــكــراً لــاهــتــمــامــك بــوطــنــك وــحــرصــك عــلــى تــطــويــر الــتــشــريــعــات فــي ♜𝑪𝑰𝑨 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚♜.
...
ــيــُــرجــى الــتــأكــد مــن أن مــشــروع الــقــرار:
 ...
 2. يــتــمــاشــى مــع قــوانــيــن وــتــشــريــعــات ♜𝑪𝑰𝑨 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚♜.
...
__**`);
 const AlShuriPoint = new ButtonBuilder({ customId: 'Al-Shuri-Setup', label: 'رفــع مــشــروع قــرار', style: 2 });
