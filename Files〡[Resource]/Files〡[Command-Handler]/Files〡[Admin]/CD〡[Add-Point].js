...
export default {
    ...
    */
    run: async (Client, Message) => {
        if (!Message.member.roles.cache.has(CommandPremission.AddPoint)) return Message.reply({ content: `**ليس لديك الصلاحية لتنفيذ هذا الامر**` });
        ...
        Embed.setDescription(`**__ تم اضافة نقاط بعدد : ${PointsNumber}
