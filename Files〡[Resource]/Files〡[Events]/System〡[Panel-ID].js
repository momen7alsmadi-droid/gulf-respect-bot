...
— [6] الــمــوافــقــة عــلــى الــمــراجــعــة: يــحــتــفــظ ســيــرفــر ♜𝑪𝑰𝑨 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚♜ بــحــق مــراجــعــة الــهــويــة فــي أي وقــت لــضــمــان الــتــزامــهــا بــالــشــروط و الــســيــاســات، و قــد يُــتــم تــعــديــل الــهــويــة أو إلــغــاؤهــا فــي حــال وجــود مــخــالــفــات
...
— يــســرنــا إعــلامــك بــقــبــول طــلــبــك لــإنــشــاء الــهــويــة فــي ♜𝑪𝑰𝑨 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚♜ و نــهــنــئــك عــلــى انــضــمــامــك إلــى هــذه الـدولـة المـتـمـيـزة حــيــث الــعــدالــة والــديــمــقــراطــيــة أســاس الــنــجــاح.
...
— تــأكــد مــن مــراجــعــة بــيــانــات هــويــتــك والــالــتــزام بــالــقــوانــيــن لــتــكــون جــزءًا فــعــالاً مــن مــجــتــمــعــنــا الــراقــي.
 ...
 — نــتــمــنــى لــك تــجــربــة مــمــتــعــة ومــمــيــزة فــي ♜𝑪𝑰𝑨 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚♜.
...
— نــأســف لــإبــلاغــك بــأنــه تــم رفــض طــلــبــك لــإنــشــاء الــهــويــة فــي ♜𝑪𝑰𝑨 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚♜ يــعــود ذلــك [${Reason}]
